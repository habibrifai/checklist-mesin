                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="../user/inspeksi_harian"> Harian</a>
                                </li>
                                <li>
                                    <a href="../user/inspeksi_mingguan"> Mingguan</a>
                                </li>
                                <li>
                                    <a href="../user/inspeksi_bulanan"> Bulanan</a>
                                </li>
                                <li>
                                    <a href="../user/inspeksi_tahunan"> Tahunan</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a class="active" href="../change_password/index.php">Ganti Password</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>

            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="<?php echo $base; ?>admin"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>
                        <li>
                            <a href="<?php echo $base; ?>admin/sop.php" target="_blank"><i class="fa fa-edit fa-fw"></i> SOP</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-file-o fa-fw"></i> Data Inspeksi<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo $base; ?>admin/harian"> Harian</a>
                                </li>
                                <li>
                                    <a href="<?php echo $base; ?>admin/mingguan"> Mingguan</a>
                                </li>
                                <li>
                                    <a href="<?php echo $base; ?>admin/bulanan"> Bulanan</a>
                                </li>
                                <li>
                                    <a href="<?php echo $base; ?>admin/tahunan"> Tahunan</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a class="active" href="<?php echo $base; ?>/change_password/admin.php">Ganti Password</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>

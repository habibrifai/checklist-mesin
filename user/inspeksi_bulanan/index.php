...
$dataBulanan = array(array('no' => 18, 'nama_inspeksi' => 'Aligment motor & gear box'), 
                    array('no' => 19, 'nama_inspeksi' => 'Aligment bearing'),
                    array('no' => 20, 'nama_inspeksi' => 'Inlet, outlet, & inside granulator'),
                    array('no' => 21, 'nama_inspeksi' => 'Connect motor & Running test'),
                    array('no' => 22, 'nama_inspeksi' => 'Pelumas riding ring & Riding gear'),
                    array('no' => 23, 'nama_inspeksi' => 'Instrumentasi control valve'),
                    array('no' => 24, 'nama_inspeksi' => 'Turnion, pinion, & trust roll'),
                    array('no' => 25, 'nama_inspeksi' => 'Labyrinth seal inlet'),
                    array('no' => 26, 'nama_inspeksi' => 'Sparger'),
                    array('no' => 27, 'nama_inspeksi' => 'Line / nozzle SA'),
                    array('no' => 28, 'nama_inspeksi' => 'Line / nozzle NH3'),
                    array('no' => 29, 'nama_inspeksi' => 'Line / nozzle Steam'),
                    array('no' => 30, 'nama_inspeksi' => 'Line / nozzle slurry'),
                    array('no' => 31, 'nama_inspeksi' => 'Ploughshare'),
                    array('no' => 32, 'nama_inspeksi' => 'Rubber panel'),
                    array('no' => 33, 'nama_inspeksi' => 'Caping'),
                    array('no' => 34, 'nama_inspeksi' => 'Blast aerator & instrumentasi plant air'));
...
<body>
    ...
    <div id="wrapper">
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <li>
                                <a class="active" href="../inspeksi_bulanan"> Bulanan</a>
                            </li>
                            <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 style="text-align: center;" class="page-header">CHECK LIST BULANAN/SHUTDOWN/START UP<br>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <form action="save_inspeksi_bulanan.php" method="POST">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <?php $no = 1; foreach ($dataBulanan as $value) { ?>
                                            <tr>
                                                <td>
                                                    <p><?php echo $no; ?></p>
                                            ...
                                            <?php
                                                $no_doc = mysqli_query($conn, "SELECT no_form FROM form WHERE periode = 'Bulanan' ORDER BY ABS(SUBSTRING(no_form,6,LENGTH(no_form))) DESC LIMIT 1");
                                                $no_dokumen = mysqli_fetch_assoc($no_doc);

                                                if (isset($no_dokumen)) {
                                                    $nomor = 'FM-B-'.(substr($no_dokumen['no_form'], -(strlen($no_dokumen['no_form'])-5)) + 1);
                                                } else {
                                                    $nomor = 'FM-B-1';
                                                }

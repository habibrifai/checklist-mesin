...
$dataHarian = array(array('no' => 1, 'nama_inspeksi' => 'Area & penerangan'), 
...
<body>
    ...
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                             <li>
                                <a class="active" href="../inspeksi_harian"> Harian</a>
                            </li>
                            <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 style="text-align: center;" class="page-header">CHECK LIST HARIAN<br>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <form action="save_inspeksi_harian.php" method="POST">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <?php foreach ($dataHarian as $value) { ?>
                                            <tr>
                                                <td>
                                            ...
                                            <?php
                                                $no_doc = mysqli_query($conn, "SELECT no_form FROM form WHERE periode = 'Harian' ORDER BY ABS(SUBSTRING(no_form,6,LENGTH(no_form))) DESC LIMIT 1");
                                                $no_dokumen = mysqli_fetch_assoc($no_doc);

                                                if (isset($no_dokumen)) {
                                                    $nomor = 'FM-H-'.(substr($no_dokumen['no_form'], -(strlen($no_dokumen['no_form'])-5)) + 1);
                                                } else {
                                                    $nomor = 'FM-H-1';
                                                }

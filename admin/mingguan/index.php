                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a class="active" href="../mingguan"> Mingguan</a>
                                </li>
                                <li>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        $dataTanggal = mysqli_query($conn, "SELECT form.no_form, hasil.no_equipment_data, form.tanggal FROM form JOIN hasil ON form.no_form = hasil.no_form WHERE form.periode = 'Mingguan' GROUP BY form.tanggal DESC HAVING COUNT(*) > 1");

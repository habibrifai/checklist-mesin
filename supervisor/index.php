            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li >
                            <a class="active" href="<?php echo $base; ?>supervisor"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>
                        <li>
                            <a href="sop.php" target="_blank"><i class="fa fa-edit fa-fw"></i> SOP</a>
                        </li>
                        <li>
                            <a href="supervisi_petugas.php"><i class="fa fa-user fa-fw"></i> Supervisi Petugas</a>
                        </li>
                        <li>
